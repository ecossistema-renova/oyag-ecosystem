...
async function overview(){
 ...
 '<section class="module-launchpad"><a href="./marketplace.html"><span>◈</span><div><strong>Marketplace</strong><small>Produtos, serviços e compras</small></div></a><a href="./academy/curso.html"><span>⌘</span><div><strong>OYAG Academy</strong><small>Aprendizado e progresso</small></div></a><a href="./community-app.html"><span>✦</span><div><strong>OYAG Community</strong><small>Troca de conhecimento</small></div></a><a href="./minhas-financas.html"><span>◉</span><div><strong>OYAG Finance</strong><small>Organização financeira</small></div></a></section>'+
