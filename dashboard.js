...
async function showAffiliateNetwork(){
 ...
 const [{data:dash,error:dashError},{data:entries,error:entriesError},{data:materials,error:materialsError}]=await Promise.all([
 ...
 const d=dash||joined||{},t=d.totals||{},items=entriesError?[]:(entries||[]),media=materialsError?[]:(materials||[]);
